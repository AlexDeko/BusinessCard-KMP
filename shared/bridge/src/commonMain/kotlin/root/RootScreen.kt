            ...
            Column(modifier = Modifier.padding(innerpadding)) {
                Children(
                    ...
                    when (val child = it.instance) {
                        is RootComponent.ChildBottom.WelcomeChild -> WelcomeContent(component = child.component)
                        is RootComponent.ChildBottom.FeedsChild -> FeedsContent(component = child.component)
                        is RootComponent.ChildBottom.MessageChild -> MessageContent(
                            component = child.component,
                            modifier
                        )

                        is RootComponent.ChildBottom.NotificationsChild -> NotificationContent(
                            component = child.component
                        )
                    }
                }
